...
<CookingStep action="frying_pan_meat_red_cubes" alt="Browning beef cubes" />

### Step 2: Sauté the Vegetables

Add **chopped onions**, **minced garlic**, and **sliced carrots** to the pot. Sauté until the vegetables are softened.

<CookingStep action="frying_pan_vegetables_onions" alt="Sautéing vegetables" />
...
<CookingStep action="stewing_meat_red_cubes" alt="Simmering beef stew" />
